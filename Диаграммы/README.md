...
1.2.1.2 [Поставить башню](#1.2.1.2)<br>
...
Поток выполнения:
1. Игрок нажимает левой кнопкой мыши на зону постройки башни.
2. Игрок выбирает какой тип башни построить.
3. Появилась башня.
4. Конец.

#### 1.2.1.3 Улучшение башни<a name="1.2.1.3"></a>
**Описание.** Позволяет пользователю улучшить башню.
